...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (!$flag) {
        ...
        if (!$flag) {
            ...
            $result1 = login($userName); //write($data_encode);
            //$row = mysqli_fetch_array($result);

            if ((strcmp($result1['password'], $password) == 0) && (strcmp($result1['position'], "admin")) == 0) {
...
<script type="text/javascript" src="../Controller/login-validation.js"></script>
